...
results = {}
x_pre = np.arange(16,1025, 8)
x_str = [str(i) for i in x_pre]
pre_total = np.zeros(x_pre.size)
for module in modules:
    inputfile = "./fit_data/fit_data_module_"+str(module)+".csv"
    input=open(inputfile,"r")
    f = csv.reader(input)
    fit_pre = open("./fit_result/pre_" + module +".csv",'w')
    ...
    for line in f:
        ...
        try:
            ...
            fit_fail.write(str(module) + "," + funcname + "\n")
