...
!EOP ___________________________________________________________________
  ...
  ! test
  character, allocatable:: ary1(:)
  
  allocate(ary1(0), stat = ier)
  
  deallocate(ary1, stat = ier)
  
  if(ier /= 0) call die(myname_,'allocate()0',ier)
  ...
  allocate(aList%bf(le),stat=ier)
  if(ier /= 0) call die(myname_,'allocate()1',ier)
  
  allocate(aList%lc(0:1,ni),stat=ier)
  if(ier /= 0) call die(myname_,'allocate()2',ier)
